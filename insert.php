...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into tblusers(FirstName,LastName,Age, MobileNumber, Email, Address) value('$fname','$lname', '$age', '$contno', '$email', '$add' )");
    if ($query) {
...
<div class="signup-form">
    <form  method="POST">
		...
		<div class="form-group">
            <input type="text" class="form-control" name="age" placeholder="Enter your Age" required="true" maxlength="10" pattern="[0-9]+">
        </div>
        <div class="form-group">
