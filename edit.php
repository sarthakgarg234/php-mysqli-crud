...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname',
	 Age='$age', MobileNumber='$contno', Email='$email', Address='$add' where ID='$eid'");
    if ($query) {
...
?>
		...
		<div class="form-group">
            <input type="text" class="form-control" name="age" value="<?php  echo $row['Age'];?>" required="true" maxlength="10" pattern="[0-9]+">
        </div>
        <div class="form-group">
